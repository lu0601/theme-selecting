...
def select_theme(mid): ##選取主旋律所在的函式
    class Select_Track:
    ...
    for i in range(select_track_num):
        selected_three_track.append(sorted_select_track[i].track_num__) ##取重疊因最少的三個track
...
if __name__ == "__main__": ###main
    ...
    begin = time.time()
    select_theme(mid)
    print(middle) ##讀取、分析midi檔的時間
    print(time.time() - begin) ##進行選取主旋律的演算法的時間
